...
_DBI_: database connection and operation in R

_netcdf_: extraction and manipulation of netcdf files in R and possibly with CDO

_dbplyr_: Use databases with dplyr

_parallel_, _foreach_: multi-core/parallel programming 

_shiny_: interactive data visualization
